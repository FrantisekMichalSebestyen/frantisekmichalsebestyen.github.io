...
const PortfolioCard = forwardRef<HTMLButtonElement, PortfolioCardProps>(({ style, ...props }, ref) => {
  return (
    <div className='relative'>
      ...
      <span className='text-5xl absolute -left-4 -bottom-4 drop-shadow-2xl z-10 font-gothic'>Atlas SNG</span> 
    </div>
  )
})
